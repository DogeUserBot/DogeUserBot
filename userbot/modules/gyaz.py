...
async def remoteaccess(event):
    ...
    if event.reply_to_msg_id:
        ...
        await event.edit("`@DogeUserBot Mesajınızı iletti ✔️`")
    for i in m[1:]:
        msg += i + " "
    if msg == "":
        return
    try:
        ...
        await event.edit("`@DogeUserBot Mesajınızı iletti`")
    except BaseException:
        await event.edit("** @DogeUserBot Mesajınızı Gönderemedi Belirttiğin Grupta Olduğuna Eminmisin Sahip ? **")
