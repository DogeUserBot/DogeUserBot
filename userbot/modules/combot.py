...
async def info(event):
    await event.edit("**Grubu analiz ediyorum...**")
...
async def get_chatinfo(event):
    ...
    try:
        ...
        try:
            ...
            await event.reply("**:/\nGeçersiz kanal ya da grup**")
            return None
        except ChannelPrivateError:
            await event.reply("**:/\nBu gizli bir grup ya da buradan yasaklandım.**")
            return None
        except ChannelPublicGroupNaError:
            await event.reply("**:/\nBöyle bir süper grup ya da kanal bulamadım.\nKullanıcı adını tekrar kontrol et!**")
            return None
